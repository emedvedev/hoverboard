...
5. Import data to the Firebase Database. You can use the [default-firebase-data.json](https://github.com/gdg-x/hoverboard/blob/master/docs/default-firebase-data.json) schema and then update it with your information:
